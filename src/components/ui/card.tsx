...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "@container/card-header tw-grid tw-auto-rows-min tw-grid-rows-[auto_auto] tw-items-start tw-gap-2 tw-px-6 has-data-[slot=card-action]:tw-grid-cols-[1fr_auto] [.border-b]:tw-pb-6",
        className
      )}
      {...props}
    />
